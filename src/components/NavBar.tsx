...
const NavBar = () => {
  return (
    <>
    <span className="flex flex-row text-2xl text-white bg-slate-800 justify-center">Latest version now live on:{" "}<a
    className="text-blue-500 pl-1"
    href="https://framesync.xyz" target={"_blank"}>{" "}framesync.xyz</a></span>
